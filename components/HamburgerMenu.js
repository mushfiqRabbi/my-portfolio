...
export default function HamburgerMenu() {
  return (
    <>
      <label
        className={`lg:hidden h-12 w-12 bg-[rgba(64,124,255,0.9)] border inline-block py-[14px] px-3 fixed top-10 right-10 rounded-full z-50 md:h-16 md:w-16 md:py-[22px] md:px-4`}
      >
      ...
      <div
        className={`lg:mx-auto  lg:mt-8 lg:bg-white lg:sticky lg:h-auto lg:border-none lg:w-full fixed h-0 w-0 bg-[#407BFF] right-0 top-0 z-40  overflow-hidden drop-shadow-md  ${styles.menu_container}`}
      >
        <nav className="lg:static lg:-translate-x-0 absolute top-20 md:top-28 left-1/2 -translate-x-[45%] md:-translate-x-1/4 lg:max-w-4xl xl:max-w-6xl mx-auto">
          <ul
