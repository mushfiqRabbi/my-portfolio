...
export default function HamburgerMenu() {
  return (
    <>
      <label
        className={`h-12 w-12 bg-[#407BFF] inline-block py-[14px] px-3 fixed top-6 right-6 rounded-full z-20`}
      >
      ...
      >
        <nav className="absolute top-14 left-1/2 -translate-x-1/4">
          <ul className={`flex flex-col gap-1 ${styles.nav_list}`}>
            <li>
              <Link
                href="#home"
                className="text-white text-xl text-center block uppercase font-light tracking-wide"
              >
                Home
              </Link>
            </li>
